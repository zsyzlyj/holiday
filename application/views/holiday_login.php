...
<div class="login_box">
    <div class="login_l_img"><img src="<?php echo base_url('assets/dist/img/login-img.png') ?>" /></div>
        <div class="login">
            <div class="login_logo"><a href="<?php echo base_url('auth/holiday_login'); ?>"><img src="<?php echo base_url('assets/dist/img/login_logo.png') ?>" /></a></div>
            ...
            <form action="<?php echo base_url('auth/holiday_login') ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                    <a href="<?php echo base_url('auth/holiday_login');?>"><img src="<?php echo base_url($_SESSION['image']);?>" style="border:1px solid black" value="验证" name="captcha"/></a>
                    </div>
                </div>
