...
<div class="login_box">
    <div class="login_l_img"><img src="<?php echo base_url('assets/dist/img/login-img.png') ?>" /></div>
        <div class="login">
            <div class="login_logo"><a href="<?php echo base_url('auth/wage_login'); ?>"><img src="<?php echo base_url('assets/dist/img/login_logo.png') ?>" /></a></div>
            <div class="login_name">
                <p>中山联通人力资源管理系统</p>
            </div>
            <form action="<?php echo base_url('auth/wage_login') ?>" method="post">
