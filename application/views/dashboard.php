      ...
      <div class="row">
          <div class="mu-hero-featured-content">
            <div class="mu-event-counter-area">
              ...
              <span class="mu-event-counter-block div3 enlargeMe3 bg-orange" style="cursor:pointer" onclick="window.open('<?php echo base_url('users/profile');?>','_self')"><span><font size="10px"><i class="fa fa-users"></i></font></span><span><p>个人信息</p></span></span>
            </div>
          </div>
      </div>
    </section>
