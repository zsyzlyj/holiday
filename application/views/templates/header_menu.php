<header class="main-header">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="<?php echo base_url('users/holiday_setting') ?>"><i class="glyphicon glyphicon-edit "></i>&nbsp;修改密码</a></li>
        ...
        <li><a href="<?php echo base_url('users/wage_setting') ?>"><i class="glyphicon glyphicon-edit "></i>&nbsp;修改密码</a></li>
